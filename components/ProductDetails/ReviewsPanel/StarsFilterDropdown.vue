...
async function fetchWithRating(rating: number) {
...
<template>
  <div class="star-dropdown">
    ...
    <ul>
      ...
      <li v-for="starAmount in 5" :key="starAmount" @click="fetchWithRating(starAmount)">
        {{ starAmount }}
        ...
        <span>({{ store.reviewRatingCounts[starAmount as 1|2|3|4|5] }})</span>
      </li>
    </ul>
  </div>
</template>
